...
- [v] GPS Quectel *LC76GPAMD*
	- [ ] Randcomponenten
- [v] BMS
	- [v] li-ion lader *BQ25630YBGR*
		- [ ] Randcomponenten
	- [v] 3,3V buck-boost *RAA2361052GNP#HC5*
		- [ ] Randcomponenten
	- [v] 3,3V LDO regulator *TCR3UG33A,LF*
		- [ ] Randcomponenten
...
- [v] ST-link
	- [v] St-link *STLINK-V3MINIE*
	- [v] Header *009159010603906*
- [v] FRAM *FM24V01A-GTR*
- [v] ePaper​ *Waveshare 1.54” module*
- [v] Accelerometer​ *LIS2DW12 module*
- [v] SD-kaart​ module  *SD adapter module*
- [v] Servo motor *TD-8120MG Digital Servo*
	- [ ] Randcomponenten
- [v] LED *BL-BEG204-7-E*
	- [ ] Weerstanden
## KiCad
